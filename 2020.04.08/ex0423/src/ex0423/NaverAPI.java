...
public class NaverAPI {
	public static String Search(String query, String display, String start) {
        String clientId = "M_i_g_sffBLTUNEepmbW"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "e2feRAuzxn"; //애플리케이션 클라이언트 시크릿값"
